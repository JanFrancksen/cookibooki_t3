...
const Navbar = () => {
  return (
    <header className='navbar w-full fixed top-0 left-0 p-4 z-50 bg-cb_blue'>
        <div className='w-3/4 m-auto flex justify-between items-center'>

        <Link href="/" ><a className="text-white font-black">CookiBooki</a></Link>
        <nav className='flex gap-x-4'>
        <Link href="rezepte"><a className='navitem'>Rezepte</a></Link>
